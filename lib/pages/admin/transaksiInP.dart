                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Obx(() {
                                                                          ...
                                                                          return Container(
                                                                            ...
                                                                            child:
                                                                                ListView.builder(
                                                                              itemCount: c.filteredProduct.length,
                    ...
                    child: Obx(() {
                      ...
                      return SingleChildScrollView(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            children:
                                List.generate(c.transaksiDet.length, (index) {
...
Widget buildCardTransaksi(String name, String noTransaksi, String tanggal,
    String jumlah, String total, String satuan, String jual, context) {
  return Card(
    elevation: 2,
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(12),
